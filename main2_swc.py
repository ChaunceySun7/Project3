...
# 导入数据
train = pd.read_csv('data_set_0926/invite_info_0926.txt', header=None, sep='\t')
test = pd.read_csv('data_set_0926/invite_info_evaluate_2_0926.txt', header=None, sep='\t')
...
# 回答距提问的天数
answer_info['回答距提问的天数'] = answer_info['问题创建时间-day'] - answer_info['回答创建时间-day']
...
# 加载用户
user_info = pd.read_csv('data_set_0926/member_info_0926.txt', header=None, sep='\t')
...
result_append.to_csv('submit/result.txt', index=False, header=False, sep='\t')
